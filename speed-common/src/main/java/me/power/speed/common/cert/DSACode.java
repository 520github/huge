...
public class DSACode {
    ...
    private static final String privatekeyFile = "ck.pem";  
      
    private static final String publickeyFile = "ck.pem";  
    ...
    private static String path = "C:\\xuehui\\50-temp\\00-receive-product\\";  
