...
public class JsonObject extends BaseObject {
    ...
    public JsonObject(String stringValue, int intValue, double doubleValue, long longValue,
	...
	public String toJson(){
        ...
        .append("\"listValue\":[\"")
	        ...
	        .append("\"listValue\":[],")
	        .append("\"nullValue\":")
	        .append(((JsonObject)this.getListValue().get(2)).getNullValue())
	        .append(",\"stringValue\":\"")
	        .append(((JsonObject)this.getListValue().get(2)).getStringValue())
	        .append("\",\"intValue\":")
	        .append(((JsonObject)this.getListValue().get(2)).getIntValue())
	        .append(",\"doubleValue\":")
	        .append(((JsonObject)this.getListValue().get(2)).getDoubleValue())
	        .append(",\"longValue\":")
	        .append(((JsonObject)this.getListValue().get(2)).getLongValue())
